...
public class CasesListAdapter extends RecyclerView.Adapter<CasesViewHolder> {
    Context context;
    ...
    public CasesListAdapter(RecyclerView recyclerView, Context context, ArrayList<CasesListClass>
